...
class WP2024_Recent_News extends WP_Widget{
    public function __construct(){
        parent::__construct(
        'wp2024_recent_news',//Base ID
        'WP2024_Recent_News',//Name
        [
        'description' => __( 'Widget hiển thị các bài viết mới nhất', 'wp2024-theme')
        ]
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance['title']) ? $instance['title'] :__( 'New title', 'wp2024-theme' );
